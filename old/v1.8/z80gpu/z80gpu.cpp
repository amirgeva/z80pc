...
uint8_t __attribute__((aligned(4), section(".data.framebuf"))) framebuf[640*480];
...
void serial_setup()
{
    ...
    //while (!tud_cdc_connected()) sleep_ms(1);
}
...
int main(void)
{
    ...
    //initialize_frame_buffer(framebuf);
