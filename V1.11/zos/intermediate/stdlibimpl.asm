...
;../stdlib/stdlibimpl.c:33: }
	ret
;../stdlib/stdlibimpl.c:44: void print_word_impl(word w)
;	---------------------------------
...
_print_word_impl::
	...
	ld	sp, iy
	ex	de, hl
;../stdlib/stdlibimpl.c:47: if (w==0) print_char('0');
	ld	a, d
	or	a, e
	jr	NZ, 00114$
	ld	a, #0x30
	call	_print_char
	jr	00110$
;../stdlib/stdlibimpl.c:53: while (w>0)
00114$:
	ld	-1 (ix), #0x00
00101$:
	ld	a, d
	or	a, e
	jr	Z, 00115$
;../stdlib/stdlibimpl.c:55: dm.a=w;
	inc	sp
	inc	sp
	push	de
;../stdlib/stdlibimpl.c:56: dm.b=10;
	ld	-7 (ix), #0x0a
;../stdlib/stdlibimpl.c:57: div_mod(&dm);
	ld	hl, #0
	add	hl, sp
	call	_div_mod
;../stdlib/stdlibimpl.c:58: text[i++]=48+dm.b;
	ld	e, -1 (ix)
	ld	d, #0x00
	ld	hl, #3
	add	hl, sp
	...
	add	a, #0x30
	ld	(de), a
;../stdlib/stdlibimpl.c:59: w=dm.a;
	pop	de
	push	de
	jr	00101$
;../stdlib/stdlibimpl.c:61: do
00115$:
	ld	hl, #3
	add	hl, sp
	ld	c, l
	...
	ld	e, -1 (ix)
00104$:
;../stdlib/stdlibimpl.c:63: print_char(text[--i]);
	dec	e
	ld	l, e
	ld	h, #0x00
	add	hl, bc
	...
	pop	de
	pop	bc
;../stdlib/stdlibimpl.c:64: } while (i>0);
	ld	a, e
	or	a, a
	jr	NZ, 00104$
00110$:
;../stdlib/stdlibimpl.c:66: }
	ld	sp, ix
	pop	ix
	ret
	.area _CODE
